...
7. 分布式锁系统所需要的最小能力子集是什么

8. 有没有使用过其它语言，Java 与其他语言对比的优缺点

### Lazada三面（9/8）

1. 项目
2. 在项目中使用过哪些设计模式、Spring 中用到了哪些设计模式
3. 注解的实现原理、失效场景
4. 面向对象五大原则
5. GC过程
6. 为什么survivor区域有两个？
7. HashMap 和 ConcurrentHashMap 的区别，ConcurrentHashMap 如何保证线程安全，你会用乐观锁还是悲观锁、为什么？
8. 让你实现 HashSet 你会怎么做
...
2. 研究方向
3. 项目
4. HTTP和HTTPS的区别、HTTPS握手过程
5. 进程和线程的关系
6. Collection 接口下的类、与 ArrayList 实现比较类似的有哪些
7. Java 中实现线程安全的方式，它们有什么区别
8. 有没有使用过 Java 原子类
9. 垃圾回收中如何判断一个对象是无用对象，有什么方法
10. Spring AOP 底层原理
11. 如何优化慢sql
12. 为什么喜欢计算机、因为喜欢做过什么，对加班的看法
